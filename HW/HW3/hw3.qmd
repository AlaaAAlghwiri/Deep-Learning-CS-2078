...
$$ \$\$ \frac{\partial{l(\theta)}}{\partial W^2_{i,j}} = \sigma \times W\^3\_{i,j} \times \sigma(z\^1)

\$\$

11. \$\$ \frac{\partial l(\theta)}{\partial W_2} =

    \begin{bmatrix}
    \delta W^3_{(1,1)} \sigma(z^1_{1}) & \delta W^3_{(1,1)} \sigma(z^1_{2}) & \delta W^3_{(1,1)} \sigma(z^1_{3}) \\
